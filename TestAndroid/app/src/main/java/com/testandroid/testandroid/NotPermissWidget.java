 ...
 */
public class NotPermissWidget extends LinearLayout {
     ...
     * 条目占总布局高百分比
     */
    private final float ITEM_HEIGHT_PERCENT = 0.05f;

    /**
     * 图标占所在布局的高百分比
     */
    private final float IV_HEIGHT_PERCENT = 0.5f;

    /**
     * 文本占所在布局的高百分比
     */
    private final float TV_SIZE_PERCENT = 0.5f;

    /**
     * 图标左侧间距
     */
    private final int IV_MARGIN_START_DP = 0;

    /**
     * 图标右侧间距
     */
    private final int IV_MARGIN_END_DP = 0;

    /**
     * 文本距离图标的左侧间距
     */
    private final int TV_MARGIN_START_TO_IV_DP = 15;

    /**
     * 文本距离图标的右侧间距
     */
    private final int TV_MARGIN_END_TO_IV_DP = 15;
    ...
    public NotPermissWidget(Context context) {
        super(context, null, 0);
    }

    public NotPermissWidget(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public NotPermissWidget(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void PlanA() {
        ...
        // 2.配置布局
        LinearLayout.LayoutParams rvp = new LinearLayout.LayoutParams(-1, -1);
